...
\begin{figure}[htp!]
    ...
    \end{subfigure}
    \caption{(\subref{app-fig:ec2_cpu_utilization_53ea38}) shows contextual anomalies, (\subref{app-fig:grok_asg_anomaly}) shows two change points and a point-anomaly.}\label{fig:artificial-anomaly-types-nab}
\end{figure}
% Spikes:
...
\section{Illustrations from Algorithms}
...
\begin{figure}[htp!]
    \begin{subfigure}[b]{\linewidth}
        ...
        shows predictions from DeepAnT, the blue line shows the original time series.}
    \end{subfigure}\label{fig:deepant-cyclicity}
    \\
    \begin{subfigure}[b]{\linewidth}
        \centering
        ...
        mostly hidden underneath the red predictions).}
    \end{subfigure}\label{fig:deepant-resemble}
    \\
    \begin{subfigure}[b]{\linewidth}
        \centering
...
\begin{figure}[htp!]
    \begin{subfigure}[b]{\linewidth}
        ...
        accuracy for almost four consecutive day.}
    \end{subfigure}\label{fig:nbeats-spike-impact}
    \\
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=.7\textwidth]{evaluation/nbeats/noisy2.png}
        \subcaption{An example of N-BEATS' lack of sensitivity to long-term cyclicity}
    \end{subfigure}\label{fig:nbeats-cyclicity}
    \\
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=.7\textwidth]{evaluation/deepant/changepoint_response.png}
...
\begin{figure}[htp!]
    \begin{subfigure}[b]{\linewidth}
        ...
        \subcaption{An example of computational instability from Holt-Winters.}\label{fig:hw-instability}
